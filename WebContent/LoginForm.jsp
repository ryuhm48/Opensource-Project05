...
<form action="login.do" method="post" name="form">
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			<th>ID</th> 
			<th><input type="text" class="form-control" name="userId" id="inputId" name="id" placeholder="ID"></th>
		</tr>
		<tr>
			<th>PW</th>
		...
		<tr>
			<th></th>
			<th>
				<input type="submit" class="btn btn-primary" id ="allCheck" value="로그인">
				<input type="button" class="btn btn-secondary" value="취소" onClick="window.location='LoginForm.jsp'">
