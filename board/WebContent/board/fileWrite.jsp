...
<body>
	...
	<form id="inform" action ="/board/write.do" method="post">
		...
		<table style="text-align:center" class="table table-striped table-bordered table-hover">
			<caption style="text-align:center">자유게시판 글 작성</caption>
			<tr >
				<th>제목</th>
			...
			<tr>	
				<th>파일 업로드</th>
				<th><label for="InputFile">파일 업로드</label>
			...
			<tr>
				...
				<th style="text-align:right">		
					...
					<input type=button class="btn btn-secondary" value="취소" OnClick="window.location='list.do?kind=${3}'">
				</th>
			</tr>
		</table>
	</form>
