...
<div class="container">
	<h1 id="Logo"><a href="../board/index.jsp">GROUP STUDY WEB PAGE</a></h1>
	<p> 사용자들끼리 문제를 공유하고 피드백을 공유하고자 만든 사이트 </p>
	<nav id="nav">
					<ul>
						<li><a class="icon fa-home" href="../board/index.jsp"><span>메인</span></a></li>
						<li>
						...
						<li><a class="icon fa-cog" href="#"><span>문제풀이</span></a>
							<ul>
								<li><a href="problemlist.do">문제풀이</a></li>
								<li><a href="answerlist.do">문제 피드백</a></li>
							</ul>
						</li>
						...
						<a class="icon fa-bars" href="#"><span>접속하기</span></a>
							<ul class="dropdown-menu">
								<li class="active"><a href="../board/LoginForm.jsp">로그인</a></li>
								<li><a href="../board/UserJoin.jsp">회원가입</a></li>
							</ul>
						</li>
					</ul>
				</nav>
