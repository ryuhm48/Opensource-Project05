...
<body>
	...
	<form id="inform" action ="NoticeBoardServlet" method="post">
		<table style="text-align:center" class="table table-striped table-bordered table-hover">
			<caption style="text-align:center">공지사항 작성</caption>
			<tr >
				<th>제목</th>
			...
			<tr>
				...
				<th style="text-align:right">		
					...
					<input type=button class="btn btn-secondary" value="취소" OnClick="location.href='NoticeBoardServlet?command=notice_board_list'">
				</th>
			</tr>
		</table>
	</form>
